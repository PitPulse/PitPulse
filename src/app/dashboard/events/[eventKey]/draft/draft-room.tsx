    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_1.6fr]">
        ...
        <section className="space-y-4">
          ...
          {/* AI Strategy Chat */}
          <div className="rounded-2xl dashboard-panel overflow-hidden">
            <button
              type="button"
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-semibold text-white">Ask PitPilot</span>
              </div>
              <svg
                className={`h-4 w-4 text-gray-400 transition-transform ${chatOpen ? "rotate-180" : ""}`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
              ...
              {chatOpen && (
                ...
                >
                  <div className="border-t border-white/10 p-4">
                    <StrategyChat eventKey={eventKey} compact />
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
