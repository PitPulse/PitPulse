  ...
  return (
    <div className="flex min-h-[calc(100vh-65px)] items-center justify-center px-4">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        ...
        />
        <motion.div
          className="absolute top-12 right-1/4 h-72 w-72 rounded-full bg-blue-600/10 blur-3xl"
        ...
        <AnimatePresence mode="wait">
          {mode === "choose" && (
            ...
            >
              <motion.button
                ...
                className="w-full rounded-xl border border-blue-500/30 bg-blue-500/10 p-5 text-left transition hover:border-blue-500/50 hover:bg-blue-500/20"
          ...
          {mode === "create" && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -8 }}
              transition={{ duration: 0.2 }}
              className="rounded-xl border border-white/10 bg-gray-900/60 p-8"
            >
              ...
              <div>
                ...
                <div className="mt-1 flex items-center gap-3">
                  ...
                  <input
                    ...
                    className="block w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2.5 text-sm text-white placeholder-gray-500 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                    placeholder="2443"
                  />
                </div>
                {/* TBA lookup result */}
              ...
              <button
                ...
                className="w-full rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white shadow-lg shadow-blue-600/20 transition hover:bg-blue-500 disabled:opacity-50"
              >
